...
if selected_cards:
    st.markdown(f"<p style='margin-top:10px;'>你已選擇：</p><p style='color:#aaffff;'>{' '.join(selected_cards)}</p>", unsafe_allow_html=True)
...
if st.button("開始模擬"):
    ...
    col1.markdown(f"<div class='result-box'><div class='result-title'>莊贏機率</div><div class='result-value'>{result_counter['莊贏'] / total:.2%}</div></div>", unsafe_allow_html=True)
    col2.markdown(f"<div class='result-box'><div class='result-title'>閒贏機率</div><div class='result-value'>{result_counter['閒贏'] / total:.2%}</div></div>", unsafe_allow_html=True)
    col3.markdown(f"<div class='result-box'><div class='result-title'>和局機率</div><div class='result-value'>{result_counter['和局'] / total:.2%}</div></div>", unsafe_allow_html=True)
